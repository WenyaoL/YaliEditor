 ...
 * @param {*} payload
 */
function updateBlock(editView,payload){
 ...
 * @param {*} payload 
 */
function updateLine(editView,payload){
    const state = editView.state
    const from = state.selection.main.from
 ...
 * @param {*} payload 
 */
function updateMulLine(editView,payload){
 ...
 * @param {*} payload 
 */
function updateOrderedLine(editView){
    const state = editView.state
    const from = state.selection.main.from
    const to = state.selection.main.to
    const lineStart = state.doc.lineAt(from).number
...
export {updateLine,updateBlock,updateMulLine}